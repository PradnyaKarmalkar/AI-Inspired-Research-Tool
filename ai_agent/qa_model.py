...
class QAModel:
    ...
    def process_directory_documents(self):
        try:
            ...
            # Store in Chroma vector db with persistence
            ...
            logger.info(f"Created vector store in {PERSIST_DIR}")
            
            return vector_store
        except Exception as e:
            logger.error(f"Failed to process directory documents: {str(e)}")
            raise
